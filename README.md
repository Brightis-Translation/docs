...
- [Start on the wiki](https://brightis-translation.github.io/docs/Getting%20Started.html) to find specifics & details.
...
- [x] Get text reinserted via tooling (found in other repos within this organization)
- [x] Figure out how to create an IPS patch
- [ ] Privately test, then publicly test the game through

### Discoveries

Please check the [wiki](https://brightis-translation.github.io/docs/) for the most up-to-date details.
